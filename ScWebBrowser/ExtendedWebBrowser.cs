  ...
  class ExtendedWebBrowser : System.Windows.Forms.WebBrowser
  {
    ...
    protected override void DetachInterfaces()
    {
      ...
      public void Zoom(int factor)
      {
          ...
          try
          {
              this.axIWebBrowser2.ExecWB(ScWebBrowser.NativeMethods.OLECMDID.OLECMDID_OPTICAL_ZOOM,
                 ScWebBrowser.NativeMethods.OLECMDEXECOPT.OLECMDEXECOPT_DONTPROMPTUSER,
