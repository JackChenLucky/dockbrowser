...
namespace WinFormsUI.Docking
{
    internal class VS2005DockPaneStrip : DockPaneStripBase
    {
        ...
        private Rectangle TabStripRectangle_Document
        {
            ...
            {
                Rectangle rect = ClientRectangle;
                //return new Rectangle(rect.X, rect.Top + DocumentStripGapTop, rect.Width, rect.Height - DocumentStripGapTop - ToolWindowStripGapBottom);chenlong 修改tabHeader高度为0
                return new Rectangle(rect.X, rect.Top + DocumentStripGapTop, rect.Width, 0);
            }
        }
        ...
        private int MeasureHeight_Document()
        {
            ...
            //直接将Tab页签的header高度设置为0 chenlong
            int height = 0;
            return height;
        }
